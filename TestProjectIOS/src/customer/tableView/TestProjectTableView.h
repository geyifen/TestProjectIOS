...
@protocol TestProjectTableViewProtocol <UITableViewDelegate>
...
@interface TestProjectTableView : UITableView
...
@property (nonatomic, weak) id<TestProjectTableViewProtocol> tableViewDelegate;
