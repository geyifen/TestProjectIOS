//
//  TestProjectTabSectionView.m
//  TestProjectIOS
//
//  Created by zjrcumac on 2023/1/29.
//

#import "TestProjectTabSectionView.h"
#import "UIView+TestProject_Constrain.h"

@interface TestProjectTabSectionView ()
...
@implementation TestProjectTabSectionView

+ (UIView<TestProjectCreateViewProtocol> *)initCreateByViewModel {
    TestProjectTabSectionView *view = [[TestProjectTabSectionView alloc] init];
    return view;
}

- (void)setViewModel:(TestProjectTabViewModel *)viewModel {
