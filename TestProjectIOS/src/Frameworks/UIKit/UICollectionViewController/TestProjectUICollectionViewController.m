//
//  TestProjectUICollectionViewController.m
//  TestProjectIOS
//
//  Created by liwenfan on 2023/8/14.
//

#import "TestProjectUICollectionViewController.h"

#import "TestProjectUICollectionCell.h"

@interface TestProjectUICollectionViewController () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation TestProjectUICollectionViewController
...
- (UICollectionViewController *)childVC {
    if (!_childVC) {
        ...
        [_childVC.collectionView registerClass:TestProjectUICollectionCell.class forCellWithReuseIdentifier:@"TestProjectUICollectionCell"];
        [_childVC.collectionView registerClass:TestProjectUICollectionReusableView.class forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"TestProjectUICollectionReusableView"];
        [_childVC.collectionView registerClass:TestProjectUICollectionReusableView.class forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"TestProjectUICollectionReusableView"];
    }
    return _childVC;
}
