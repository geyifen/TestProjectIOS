//
//  TestProjectFontDescriptor.m
//  TestProjectIOS
//
//  Created by zjrcumac on 2023/6/20.
//

#import "TestProjectFontDescriptor.h"

@interface TestProjectFontDescriptor ()
...
@implementation TestProjectFontDescriptor
...
- (NSMutableArray *)TestProjectFontDescriptor_fontDescriptorWithDesign:(NSInteger)index {
    ...
    for (NSDictionary *dic in arr) {
        ...
        NSAttributedString *attrStr = [TestProjectFontDescriptor getAttrStringFromFontDescriptor:fontDescriptor];
