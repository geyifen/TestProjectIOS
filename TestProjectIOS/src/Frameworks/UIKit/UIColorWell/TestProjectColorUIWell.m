//
//  TestProjectColorUIWell.m
//  TestProjectIOS
//
//  Created by liwenfan on 2023/6/19.
//

#import "TestProjectColorUIWell.h"

API_AVAILABLE(ios(14.0))
@interface TestProjectColorUIWell ()
...
API_AVAILABLE(ios(14.0))
@implementation TestProjectColorUIWell
...
- (NSMutableArray *)TestProjectColorWell_property_supportsAlpha:(TestProjectTableViewParams *)params {
    NSArray *arr = @[
        @{
...
- (NSDictionary *)method_3:(TestProjectTableViewParams *)params {
    return @{
        @"dataModel": @{
            ...
            @"dataModel": @{
                @"childItems": [self TestProjectColorWell_property_supportsAlpha:params],
            }
        },
    };
}

- (NSMutableArray *)TestProjectColorWell_property_selectedColor:(TestProjectTableViewParams *)params {
...
- (NSDictionary *)method_2:(TestProjectTableViewParams *)params {
    return @{
        @"dataModel": @{
            ...
            @"isDataModelExpand": @(YES),
            @"dataModel": @{
                @"childItems": [self TestProjectColorWell_property_selectedColor:params],
            }
        },
    };
}

- (NSMutableArray *)TestProjectColorWell_property_title:(TestProjectTableViewParams *)params {
    return [self createModelSingleArrayWithParams:params
                                         property:@"title"
                                            value:@"colorWell"
...
- (NSDictionary *)method_1:(TestProjectTableViewParams *)params {
    return @{
        @"dataModel": @{
            ...
            @"desc": @"不设置时，默认时colors",
            @"dataModel": @{
                @"childItems": [self TestProjectColorWell_property_title:params],
            }
        },
    };
}
